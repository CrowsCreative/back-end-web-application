...
$data = array();
$sql = "SELECT * FROM modem,produits WHERE modem.idproduit = produits.id  AND modem.n_serie = $n_serie";
...
<body>
    ...
    <div class="wrapper d-flex">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./modifier-modem.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="content" class="p-2 p-md-3 ">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./modifier-modem.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
            ...
            <h1 id="title-page"><i class="fa fa-angle-right"></i> <strong>Modifier Modem</strong></h1>
            ...
            <section class="content-page medem-content">
                ...
                <form action="update.php" method="POST">
                    ...
                    <button class="btn btn-primary mt-3" type="submit"  name="modifier-modem" value="<?php echo $data[0]['n_serie'] ?>">submit</button>
                </form>
