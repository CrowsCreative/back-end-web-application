                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./profile-admin-full.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                            ...
                            <li class="nav-item">
                                <div class="dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./profile-admin-full.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
