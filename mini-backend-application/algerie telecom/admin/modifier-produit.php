...
$data = array();
$sql = "SELECT * FROM produits WHERE produits.id = $userID";
...
<body>
    ...
    <div class="wrapper d-flex">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./modifier-produit.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="content" class="p-2 p-md-3 ">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./modifier-produit.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
            ...
            <h1 id="title-page"><i class="fa fa-angle-right"></i> <strong>Modifier Produit</strong></h1>
                 ...
                 <form action="update.php" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-row">
                         <div class="form-group col-md-6">
                             ...
                             <input type="text" class="form-control" id="inputNom" name="nom" value="<?php echo $data[0]['nom']; ?>" required>
                         </div>
                         <div class="form-group col-md-6">
                             <label for="inputPrix" class="form-label">prix</label>
                             <input type="number" class="form-control" id="inputPrix" name="prix" value="<?php echo $data[0]['prix']; ?>" required>
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="form-group col-12">
                             <label for="inputDescription">déscription</label>
                             <textarea class="form-control" id="inputDescription" name="description" rows="2" required><?php echo $data[0]['description']; ?></textarea>
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="form-group col-12">
                     ...
                     <div class="form-row">
                         <div class="d-flex align-items-center">
                             <button class="btn btn-primary mt-3" type="submit" name="modifier-product" value="<?php echo $userID ?>">terminer</button>
                         </div>
                     </div>
