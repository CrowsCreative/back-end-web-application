    ...
    <div class="wrapper d-flex">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./detail-modem.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="content" class="p-2 p-md-3 ">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./detail-modem.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
            ...
            <section class="content-page p-5 medem-content">
                ...
                <hr>
                <?php echo "<a href='./modifier-modem.php?n_serie=".$data[0]['n_serie']."' style='float: right;'>modifier ce modem ?</a>";?>
            </section>
