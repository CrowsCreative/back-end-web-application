...
$data = array();
$sql = "SELECT DISTINCT * FROM produits WHERE produits.type = 'modem' AND produits.nature = '$choose_nature'";
...
<head>
    ...
    <title>Ajouter modem ADSL</title>
</head>
<body>
    ...
    <div class="wrapper d-flex">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./ajouter-modem.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="content" class="p-2 p-md-3 ">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./ajouter-modem.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
            ...
            <h1 id="title-page"><i class="fa fa-angle-right"></i> <strong>Ajouter Modem</strong></h1>

            <section class="content-page medem-content">
               <div class="d-flex flex-row justify-content-around">
                    <div class="modem-img-container">
                        <img src="./images/dlink.jpg" alt="" width="350" height="300">
                    </div>
               </div>
                <form action="insert.php" method="POST">
                    <hr>
                    <h2>choisis un modem :</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                <?php 
                                foreach($data as $modemData)
                                {

                                    echo "<tr>";
                                        echo "<th scope='row'><input class='form-check-input' type='radio' name='id' value='".$modemData["id"]."' > ".$modemData["id"]."</th>";
                                        echo "<td>".$modemData["type"]."</td>";
                                        echo "<td>".$modemData["nature"]."</td>";
                                        echo "<td>".$modemData["nom"]."</td>";
                                        echo "<td>".$modemData["prix"]."</td>";
                                    echo "</tr>";
                                }
                                ?>
                        </tbody>
                    ...
                    <div class="form-row">
                        ...
                        <div class="d-flex align-items-center">
                            <button class="btn btn-primary mt-3" type="submit" name="ajouter-modem">générer</button>
                        </div>
                    </div>
                </form>
