...
$sql_adsl = "SELECT * FROM modem,produits WHERE modem.idproduit = produits.id AND produits.nature = 'ADSL'";
...
if($racords_adsl)
{
    ...
    $sql_4glte = "SELECT * FROM modem,produits WHERE modem.idproduit = produits.id AND produits.nature = '4GLTE'";
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="produitSubmenu">
                          ...
                          <li class="active"><a href="./modem.php"><i class="fa fa-ethernet"></i> MODEM</a> </li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="parametreSubmenu">
                          ...
                          <li><a href="./modem.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" aria-label="">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./modem.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
             ...
             <div class="row justify-content-center">
                <div class="col-xs-11 col-md-5  mx-2 mb-3 px-4 py-3 cards card-2 d-flex flex-row justify-content-between align-items-center">
                    <div>
                        <span><?= $data_staistique[0]['revenue_ADSL_m']?> <span>DA</span></span>
                ...
                <div class="col-xs-11 col-md-5 mx-2 mb-3 px-4 py-3 cards card-4 d-flex flex-row justify-content-between align-items-center">
                    <div>
                        <span><?= $data_staistique[0]['revenue_4G_m']?> <span>DA</span></span>
                        <div>total Bénéfices</div>
                    </div>
                    <div class="">
            ...
            <div class="list-client">
                <div class="col-md-12">
                    <div class="content-panel">
                        <?php 
                            echo "<h4 style='display: inline-block; color: #7289da;'><i class='fa fa-angle-right'></i> ADSL Modem</h4>";
                            echo "<a href='./ajouter-modem.php?nature=ADSL' class='btn btn-success btn-md' style='float: right; margin-right: 10px;' title='ajouter modem ADSL'>";
                        ...
                        <div id="scrollContent">
                            <table class="table table-striped table-advance table-hover">
                                ...
                                <tbody id="scrollContent">
                                    <?php 
                                    foreach($data_adsl as $modemData)
                                    {
                                       echo "<tr>";
                                       echo "<th scope='row'>".$modemData["id"]."</th>";
                                       echo "<td>".$modemData["nom"]."</td>";
                                       echo "<td>".$modemData["n_serie"]."</td>";
                                       echo "<th scope='col'>".$modemData["prix"]."</th>";
                                       echo "<td style='float: right;width:135px;' class='d-flex flex-row justify-content-between'>";
                                       echo "<a href='./detail-modem.php?n_serie=".$modemData["n_serie"]."' class='btn btn-success btn-sm' title='plus détail'><i class='fa fa-info-circle'></i></a>";
                                       echo "<a href='./modifier-modem.php?n_serie=".$modemData["n_serie"]."' class='btn btn-primary btn-sm' title='modifier information client'><i class='fa fa-pencil-alt'></i></a>";
                                       echo "<form action='delete.php' method='POST'><button type='submit' name='DELETE_modem' value='".$modemData["n_serie"]."' class='btn btn-danger btn-sm' title='supprimer client'><i class='fa fa-trash-alt'></i></button></from></td></tr>";
                                        echo "</td></tr>";
                                    }
                                    ?>
                                </tbody>
             ...
             <div class="list-client">
                <div class="col-md-12">
                    <div class="content-panel">
                        <?php 
                            echo "<h4 style='display: inline-block; color: #7289da;'><i class='fa fa-angle-right'></i> 4GLTE Modem</h4>";
                            echo "<a href='./ajouter-modem.php?nature=4GLTE' class='btn btn-success btn-md' style='float: right; margin-right: 10px;' title='ajouter modem 4GLTE'>";
                                echo "<i class='fa fa-plus'></i>";
                            echo "</a>";
                        ?>
                        <hr>
                        <div id="scrollContent">
                            <table class="table table-striped table-advance table-hover">
                                ...
                                <tbody id="scrollContent">
                                    <?php 
                                    foreach($data_4glte as $modemData)
                                    {
                                       echo "<tr>";
                                       echo "<th scope='row'>".$modemData["id"]."</th>";
                                       echo "<td>".$modemData["nom"]."</td>";
