...
$data = array();
$sql = "SELECT * FROM produits,output_images WHERE produits.id = output_images.Id AND produits.id = $userID";
...
<body>
    ...
    <div class="wrapper d-flex">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="parametreSubmenu">
                      ...
                      <li><a href="./detail-produit.php?logout='1'"><i class="fa fa-sign-out-alt"></i> LOGOUT</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div id="content" class="p-2 p-md-3 ">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navParametretSubmenu">
                                        ...
                                        <a class="dropdown-item" href="./detail-produit.php?logout='1'">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
            ...
            <h1 id="title-page"><i class="fa fa-angle-right"></i> <strong>Détail Produit</strong></h1>

            <section class="content-page p-5 medem-content">
                <div class="d-flex flex-column align-items-center">
                    <div class="modem-img-container display-img">
                        <?php echo "<img src='produit-image.php?id=".$userID."' width='350' height='300'>"; ?>
                    </div>
                ...
                <div class="mt-5 other-informations">
                    ...
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                            <label class="h2"><strong>prix : </strong></label>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                            <label class="h3"><strong>totalreveue : </strong></label>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="h3"><?php echo $data[0]['totalreveue']; ?></label>
                        </div>
                    </div>
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                            <label class="h3"><strong>nombretotal : </strong></label>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="h3"><?php echo $data[0]['nombretotal']; ?></label>
                        </div>
                    </div>
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                            <label class="h3"><strong>quantite : </strong></label>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="h3"><?php echo $data[0]['quantite']; ?></label>
                        </div>
                    </div>
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                            <label class="h3"><strong>n_achats : </strong></label>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="h3"><?php echo $data[0]['n_achats']; ?></label>
                        </div>
                    </div>
                    <div class="form-row detail-client-row">
                        <div class="form-group col-md-6 mb-3 mb-md-0">
                        ...
                        <div class="form-group col-md-6">
                            <p class="h3" style="height: 100px; overflow-x: auto;">
                ...
                <hr>
                <?php echo "<a href='./modifier-produit.php?id=".$userID."' style='float: right;'>modifier ce modem ?</a>"?>
            </section>
