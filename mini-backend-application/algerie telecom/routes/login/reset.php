...
<body >
    ...
    <div id="particles-js"></div> 
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-12 col-lg-4 d-flex justify-content-center align-items-center">
            <form action="reset.php" method="POST" class="password-strength form p-4 bg-light text-dark">
            
            
              <h3 class="form__title text-center mb-4" style="color: #183969;">Réninitialiser votre mot du passe <i class="fas fa-key"></i></h3>
              ...
              <button id="shit" class="password-strength__submit d-flex m-auto button"
                 type="submit" name="RESET" value="RESET" disabled="disabled">Soumettre
              </button>
            </form>
  ...
  <script src="./assets/script/reset.js"></script>
