    ...
    <div id="particles-js"></div> 
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-12 col-lg-4 d-flex justify-content-center align-items-center">
            <form action="login.php" method="POST" class="password-strength form p-4 bg-light text-dark">
            
            
              <h3 class="form__title text-center mb-4" style="color: #183969;">Se connectez <i class="fas fa-sign-in-alt"></i></h3>
              <div class="form-group">
                <label for="username-input">numéro téléphone</label>
                <div class="input-group">
                  <input class="form-control sign-up" type="text" id="username-input" name="username"
                    aria-describedby="usernameHelp" placeholder="numéro téléphone"  required />
                </div>
              </div>
              <div class="form-group">
                <label for="password-input">Mot de passe</label>
                <div class="input-group">
                  <input class="password-strength__input form-control" type="password" name="password"
              ...
              <button id="shit" class="password-strength__submit d-flex m-auto button"
                 type="submit" name="LOGIN" value="LOGIN" disabled="disabled">Soumettre
              </button>
            </form>
