...
const unblockSubmitBtn = (btn, strength, valideUsername, validSubmit) => {
  console.log(strength, valideUsername, validSubmit)
  if (strength === 'none' || strength === 'weak' || strength === 'moderate' || !valideUsername || !validSubmit) {
...
const passwordStrength = (input, strengthBar, btn, valideUsername, validSubmit) => {
  ...
  if (error) {
    ...
    unblockSubmitBtn(btn, strength, valideUsername, validSubmit);
  }
...
input.addEventListener("keyup", (e)=>
{
    if(pattern.test(e.target.value))
    {
        ...
        valideUsername = true;
        passwordStrength(DOM.passwInput, DOM.strengthBar, DOM.submitBtn, valideUsername, validSubmit);
    }else
    {
