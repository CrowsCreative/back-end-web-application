...
<body class="bg-light">
  ...
  <div id="circularMenu1" class="circular-menu circular-menu-left">
    ...
    <menu class="items-wrapper">
      ...
      <a href="network.php?logout_user='1'" class="menu-item fa fa-sign-out-alt" data-toggle="tooltip" data-placement="right" title="Déconnexion"></a>
    </menu>
            ...
            <div class="row ">
              ...
              <div
                ...
                <a id="item-nav" href="./demande.php" class="menu-item no-decoration text-center"><span id="nav-text">Demande en
                    ligne</span></a>
                <a id="item-nav-active" href="./network.php" class="menu-item no-decoration text-center"><span id="nav-text">Notre
                    réseaux</span></a>
              </div>
              ...
              <div class="col-lg-8 d-md-none">
                ...
                <div class="collapse" id="collapseExample">
                  ...
                  <a id="item-sm-nav" href="./demande.php" class="menu-item no-decoration text-center "><span id="nav-text">Demande
                      en ligne</span></a>
                  <a id="item-sm-nav-active" href="./network.php" class="menu-item no-decoration text-center "><span id="nav-text">Notre
                      réseaux</span></a>
                </div>
              </div>
  ...
  <section id="main">
    <div class="container">
      <div class="container">
        <div class="row">
         <iframe class="demande" src="https://www.algerietelecom.dz/fr/agence" frameborder="0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
