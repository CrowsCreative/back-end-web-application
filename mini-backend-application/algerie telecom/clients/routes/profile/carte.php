...
{
  $_SESSION['ERROR'] = "vous n'avez pas de cartes";
}
?>
<!doctype html>
<html lang="en">
...
<body class="bg-light">
  ...
  <div id="circularMenu1" class="circular-menu circular-menu-left">
    ...
    <menu class="items-wrapper">
      ...
      <a href="carte.php?logout_user='1'" class="menu-item fa fa-sign-out-alt" data-toggle="tooltip" data-placement="right" title="Déconnexion"></a>
    </menu>
